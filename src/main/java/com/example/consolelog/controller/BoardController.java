...
public class BoardController {
    ...
    public ResponseDto<?> getBoard(@PathVariable Long boardId){
        return boardService.getBoard(boardId);
    }

    // 게시물 수정
    @PutMapping(value = "/{board_id}")
    public ResponseDto<?> updateBoard(@PathVariable Long boardId, @RequestBody BoardRequestDto boardRequestDto, @AuthenticationPrincipal MemberDetailsImpl memberDetails){
